...
freqs = range((zeroth_frequency - 2),(zeroth_frequency + 2))
f0 = nrel5MW.q_of_interest['vf_0_harmonics_sorted'][:,freqs,:]  # assuming shape (n_omegas, n_harmonics, n_dof)
